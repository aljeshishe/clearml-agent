...
clearml-agent --config-file clearml.conf daemon --foreground --docker aljeshishe/agent-image:v1 --queue _grachev --create-queue --force-current-version --dynamic-gpus --queue _2gpu=2 _1gpu=1
